            ...
            <div className="col-md-7">
              <div className="texto-home">
                <h1 className="titulo-principal">
                  Olá, meu nome é Guilherme. Sou desenvolvedor Front-End e você
                  está no meu portfólio.{" "}
                </h1>
                <a className="suave" onClick={handleClick} href="#contato">
                  entrar em contato
                </a>
              </div>
            </div>
